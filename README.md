...
| Grok Build (xAI) | Loads via Claude Code compatibility; `/flow-next:*` run when typed + hooks fire (autocomplete under-lists; multi-agent unverified) — [details](plugins/flow-next/docs/platforms.md#grok-build-claude-code-compatibility) |
